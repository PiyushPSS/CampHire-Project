    ...
    return (
        <div className={isHome ? 'bg-[#cbcfff] pb-6' : 'bg-[#fcfcfc] pb-6'}>
            <div className='flex items-center justify-between mx-auto max-w-7xl pt-10'>
                <div>
                    <Link to="/"><h1 className='font-canvaSans font-bold text-[35px]'>camphire.</h1></Link>
                </div>
                ...
                <div>
                    {
                        !user ? (
                            <div className='flex items-center gap-2'>
                                <Link to="/login"><Button className="rounded-xl text-[16px] py-2 font-semibold font-canvaSans px-6">Login</Button></Link>
                                <Link to="/signup"><Button className="rounded-xl text-[16px] py-2 font-semibold font-canvaSans px-6 bg-white border-2 border-black text-black hover:text-white hover:bg-black">Signup</Button></Link>
                            </div>
                        ) : (
                            <Popover>
